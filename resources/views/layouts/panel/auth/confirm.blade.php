@component('layouts.panel.auth.auth')
    <!-- Confirm Password -->
    <div class="card">
        <div class="card-body">
            <!-- Logo -->
            ...
            <!-- /Logo -->
            <h4 class="mb-2">تایید حساب</h4>
            <p class="mb-4">جهت امنیت بیشتر ما نیاز داریم حساب کاربری شما را تایید کنیم . برای تایید حساب رمز عبور خود
                را وارد کنید .</p>
            @if (session('status'))
